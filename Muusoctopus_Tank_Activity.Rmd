...
This block of code reads in data as a csv file
```{r}
activity=read.csv(file="TankBurrows.csv")
...
activity.nonburrowers.chi=chisq.test(activity.nonburrowers,p=activity.total.probs)

activity.nonburrowers.chi
