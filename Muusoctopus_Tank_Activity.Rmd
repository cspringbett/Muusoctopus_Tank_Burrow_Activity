...
```{r}
DayHist(activity$realtime[activity$Octopus_Tank!="Amanda_CS2"&activity$Octopus_Tank!="Joe_CS1"&activity$Octopus_Tank!="Naddlie_CS1"&activity$Octopus_Tank!="Rian_CS5"],date="07/31/2022",hist.zoom=10)
```
